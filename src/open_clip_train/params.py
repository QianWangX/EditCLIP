...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "auto", "ip2p", "merged"],
        default="auto",
    ...
    parser.add_argument("--lr-newconv", type=float, default=None, help="Learning rate for the newly added conv.")
    ...
    parser.add_argument(
        ...
        default="ultraedit",
        type=str,
        help="Name of the additional dataset to use."
    )
    parser.add_argument(
        "--use_mask",
        default=False,
        action="store_true",
        help="Use mask for additional dataset."
    )
