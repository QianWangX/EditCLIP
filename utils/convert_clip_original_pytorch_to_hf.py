...
def convert_clip_checkpoint(checkpoint_path, pytorch_dump_folder_path, config_path=None,
    ...
    #     pt_model = torch.load(f, map_location="cpu")
    ...
    pixel_values = torch.randn(1, in_channels, 224, 224)
    ...
    hf_model.save_pretrained(pytorch_dump_folder_path, safe_serialization=True)
...
if __name__ == "__main__":
    ...
    convert_clip_checkpoint(args.checkpoint_path, args.pytorch_dump_folder_path, args.config_path, args.in_channels)